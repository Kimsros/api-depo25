...
class ProductImageController extends Controller
{
    ...
    public function index(Request $request)
    {
        try{
            ...
            if(isset($request->search)){
                return response()->json(['success'=>SeachTable::getSearch('product_images',$request->search,array(),$per_page)]);
            }
            return response()->json(['success'=>product_image::orderBy('id','DESC')->paginate($per_page)]);
        }catch(\Exception $e){
    ...
    {
        try{
            if(product_image::whereIn('id',explode('-',$id))->delete()){
