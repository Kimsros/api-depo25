  ...
  <div class="card bg-transparent">
    ...
    >
      ...
      >
        ...
        <div class="star">
          <a href="#"
            ><img src="/backend/assets/img/svg/star.svg" alt="" class="svg"
          /></a>
        </div>
        <!-- End Starred -->
                ...
                <a href="#" class="current">
                    <div class="form-row">
                        <div class="col-12 text-right">
                            <router-link to="add_blog" type="submit" class="btn long">Add More</router-link>
                        </div>
                    </div>
                </a>
            </li>
        ...
        <tbody>
          <tr v-for="(item, idx) in data.data" :key="idx">
            ...
            <td class="actions">
              ...
              <router-link :to="'/admin/edit_blog/' + item.id">
                <span>
                  <img
