    ...
    methods:{
        getAllUserList(url=null){
            if(url!=null){
                ...
                axios.get('/api/user/?user_type=Admin&page='+urls).then((response) => {
                    if (response.data.success) {
                        this.allUserList = response.data.success;
                    }
                });
            }else{
                axios.get('/api/user/?user_type=Admin').then((response) => {
                    if (response.data.success) {
                        this.allUserList = response.data.success;
                    }
                });
        ...
        searchUser(){
            axios.get('/api/user/?user_type=Admin&search='+this.search).then(response=>{
                if(response.data.success){
                    this.allUserList=response.data.success;
                }
            });
