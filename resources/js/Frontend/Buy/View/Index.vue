            ...
            <div class="page-content">
                <div class="container">
                                ...
                                <div class="product shadow-media">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h3 class="product-name">
                                            <a href="/buy_detail">Beyond Top NLY Trend</a>
                                        </h3>
                                        ...
                                        <div class="ratings-container">
                                            ...
                                            <a href="/buy_detail" class="rating-reviews">( 6 reviews )</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3 col-6">
                                <div class="product shadow-media">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h3 class="product-name">
                                            <a href="/buy_detail">Osaka Entry Tee Superdry</a>
                                        </h3>
                                        <div class="product-price">
                            ...
                            <div class="col-md-3 col-6">
                                <div class="product shadow-media">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h3 class="product-name">
                                            <a href="/buy_detail">Pima SS O-Neck NOOS Homme</a>
                                        </h3>
                                        <div class="product-price">
                                ...
                                <div class="product shadow-media">
                                    ...
                                    <div class="product-details">
                                        <a href="#" class="btn-wishlist" title="Add to wishlist"><i
                                                class="d-icon-heart"></i></a>
                                        <div class="product-cat">
                                            <a href="shop-grid-3col.html">fashion</a>
                                        </div>
                                        <h3 class="product-name">
                                            <a href="/buy_detail">Blue Utility Pinafore Denim Dress</a>
                                        </h3>
                                        <div class="product-price">
                            ...
                            <div class="col-md-3 col-6">
                                <div class="product product-classic product-variable">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <div class="product-action">
                                            <a href="/buy_detail" class="btn-product btn-cart"
                    ...
                    <section class="mt-8">
                        ...
                        <div class="row product-wrapper split-line">
                            <div class="col-xl-5col col-lg-3 col-sm-4 col-6">
                                <div class="product product-slideup text-center product-variable">
                                    ...
                                    <div class="product-details">
                                        <div class="product-cat">
                                            <a href="shop-grid-3cols.html">bags</a>
                                        </div>
                                        <h3 class="product-name">
                                            <a href="/buy_detail">Beyond Top NLY Trend</a>
                                        </h3>
                    ...
                    <section class="mt-10">
                        ...
                        <div class="owl-carousel owl-theme row cols-2 cols-md-3 cols-lg-4 cols-xl-5 gutter-xs"
                            data-owl-options="{
                            'items': 5,
                            'nav': false,
                            'loop': false,
                        ...
                        <div class="owl-carousel owl-theme row cols-lg-4 cols-md-3 cols-2" data-owl-options="{
                            ...
                            <div class="product product-variable text-center shadow-media cart-full">
                                ...
                                <div class="product-details">
                                    ...
                                    <a href="/buy_detail" class="btn-product btn-cart" title="Select Options">Select
                                        Options</a>
                                </div>
                            </div>
                            <div class="product product-variable text-center shadow-media cart-full">
                                            ...
                                            <div class="products-col">
                                                ...
                                                <div class="product product-list-sm">
                                                    ...
                                                    <div class="product-details">
                                                        ...
                                                        <div class="product-price">
                                                            <ins class="new-price">$98.00</ins><del
                                                                class="old-price">$210.00</del>
                                                        </div>
                                                        <div class="ratings-container">
                                                            <div class="ratings-full">
                ...
                <section class="element-section mt-8">
                    <div class="container">
                        ...
                        <div class="row elements">
                            ...
                            <div class="col-xl-5col col-lg-3 col-md-4 col-sm-6 col-12">
                                <a href="element-blog-posts.html" class="element-type">
                            ...
                            <div class="col-xl-5col col-lg-3 col-md-4 col-sm-6 col-12">
                                <a href="element-buttons.html" class="element-type">
                            ...
                            <div class="col-xl-5col col-lg-3 col-md-4 col-sm-6 col-12">
                                <a href="element-cta.html" class="element-type">
                            ...
                            <div class="col-xl-5col col-lg-3 col-md-4 col-sm-6 col-12">
                                <a href="element-icon-boxes.html" class="element-type">
                            ...
                            <div class="col-xl-5col col-lg-3 col-md-4 col-sm-6 col-12">
                                <a href="element-icons.html" class="element-type">
                                    <div class="element element-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="82px"
                                            height="82px" viewBox="0 0 70 70" xml:space="preserve">
                                            <g>
                                                <path fill="none" stroke="#666" stroke-width="1.5"
                            ...
                            <div class="col-xl-5col col-lg-3 col-md-4 col-sm-6 col-12">
                                <a href="element-instagrams.html" class="element-type">
                            ...
                            <div class="col-xl-5col col-lg-3 col-md-4 col-sm-6 col-12">
                                <a href="element-categories.html" class="element-type">
                            ...
                            <div class="col-xl-5col col-lg-3 col-md-4 col-sm-6 col-12">
                                <a href="element-products.html" class="element-type">
                            ...
                            <div class="col-xl-5col col-lg-3 col-md-4 col-sm-6 col-12">
                                <a href="element-tabs.html" class="element-type">
                            ...
                            <div class="col-xl-5col col-lg-3 col-md-4 col-sm-6 col-12">
                                <a href="element-testimonials.html" class="element-type">
                            ...
                            <div class="col-xl-5col col-lg-3 col-md-4 col-sm-6 col-12">
                                <a href="element-titles.html" class="element-type">
                            ...
                            <div class="col-xl-5col col-lg-3 col-md-4 col-sm-6 col-12">
                                <a href="element-typography.html" class="element-type">
                            ...
                            <div class="col-xl-5col col-lg-3 col-md-4 col-sm-6 col-12">
                                <a href="element-alerts.html" class="element-type">
                                    <div class="element element-video">
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" class="pt-1 pb-1" x="0px" y="0px"
                                            width="50px" height="62px" viewBox="0 0 70 70" xml:space="preserve">
                                            <g>
                                                <path
