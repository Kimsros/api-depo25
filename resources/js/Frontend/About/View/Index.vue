<template>
    <main class="main">
        ...
        <div class="page-header pl-4 pr-4" style="background-image: url(/frontend/images/page-header/about-us.jpg)">
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-md-7 mb-4">
                            <figure>
                                <img src="/frontend/images/subpages/customer.jpg" alt="Happy Customer" width="580"
                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6 mb-4">
                            <figure>
                                <img src="/frontend/images/subpages/store.jpg" alt="Our Store" width="580" height="507"
                ...
                <div class="container mt-8 mb-10">
                    ...
                    <div class="owl-carousel owl-theme row cols-xl-6 cols-lg-5 cols-md-4 cols-sm-3 cols-2"
                        ...
                        <figure class="brand-wrap bg-white banner-radius">
                            <img src="/frontend/images/brands/1.png" alt="Brand" width="180" height="100" />
                        </figure>
                        <figure class="brand-wrap bg-white banner-radius">
                            <img src="/frontend/images/brands/2.png" alt="Brand" width="180" height="100" />
                        </figure>
                        <figure class="brand-wrap bg-white banner-radius">
                            <img src="/frontend/images/brands/3.png" alt="Brand" width="180" height="100" />
                        </figure>
                        <figure class="brand-wrap bg-white banner-radius">
                            <img src="/frontend/images/brands/4.png" alt="Brand" width="180" height="100" />
                        </figure>
                        <figure class="brand-wrap bg-white banner-radius">
                            <img src="/frontend/images/brands/5.png" alt="Brand" width="180" height="100" />
                        </figure>
                        <figure class="brand-wrap bg-white banner-radius">
                            <img src="/frontend/images/brands/6.png" alt="Brand" width="180" height="100" />
                        </figure>
                    </div>
                </div>
            </section>
                    ...
                    <div class="row cols-sm-2 cols-md-4">
                        <div class="member appear-animate" data-animation-options="{'name': 'fadeInLeftShorter'}">
                            <figure class="banner-radius">
                                <img src="/frontend/images/subpages/team1.jpg" alt="team member" width="280" height="280"
                        ...
                        <div class="member appear-animate"
                            ...
                            <figure class="banner-radius">
                                <img src="/frontend/images/subpages/team2.jpg" alt="team member" width="280" height="280"
                        ...
                        <div class="member appear-animate"
                            ...
                            <figure class="banner-radius">
                                <img src="/frontend/images/subpages/team3.jpg" alt="team member" width="280" height="280"
                        ...
                        <div class="member appear-animate"
                            ...
                            <figure class="banner-radius">
                                <img src="/frontend/images/subpages/team4.jpg" alt="team member" width="280" height="280"
